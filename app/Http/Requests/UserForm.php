...
class UserForm extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'center' => 'nullable|string', // El campo de centro es opcional y debe ser una cadena de caracteres con un máximo de 20 caracteres.
            'description' => 'nullable|string|max:150', // El campo de descripción es opcional y debe ser una cadena de caracteres con un máximo de 255 caracteres.
